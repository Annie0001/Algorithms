# Consider the following list: a -> b -> c
# If node b is removed from the list, the new list should be: a -> c
...
# b will be “removed” for us in a process called Garbage Collection.
